\documentclass[11pt, a4paper]{TechCV}
...
\begin{document}
% Title name
\namesection{Aishwarya}{\color[HTML]{1C6D73} Sahu}{
\phone{\href{tel:0402006345}{0402 006 345}} 
\email{\href{mailto:aishwarya.s@live.com}{aishwarya.s@live.com}}
\globe {\href{https://www.ashsahu.com/}{ashsahu.com}}
...
\descript{TECH STACK: PYTHON, CHATGPT, FLASK, FLY.IO, GIT}
...
\descript{TECH STACK: NEXTJS, NETLIFY, GIT}
...
\descript{TECH STACK: DRF, REACTJS, NETLIFY, FLY.IO, GIT}
...
\descript{CodeCreate}
\cvevent{Jun 2017 – Jul 2018}{Sydney, NSW} 
\vspace{\topsep} % Hacky fix for awkward extra vertical space
